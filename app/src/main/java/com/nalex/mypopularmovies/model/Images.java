...
public class Images {
    ...
    /*  POJO class reflecting the system wide configuration information
     *  for images. Can be used to get the base URL for posters and
     *  allowed poster sizes. Tried but not used.
     */
